  ...
  private EmployeeService employeeService;
   ...
   @GetMapping("/")
     ...
     public ModelAndView deleteEmployee(@RequestParam("id") int id) {
         ModelAndView mv = new ModelAndView();
         String msg = employeeService.deleteemp(id);
	...
	Employee emp = employeeService.checkemplogin(eemail, epwd);
     ...
     public String searchEmployee(@RequestParam("employeeId") String employeeId, Model model) {
         List<Employee> employees = employeeService.searchEmployeesById(employeeId);
         model.addAttribute("emplist", employees);
         model.addAttribute("empcount", employees.size());
         return "viewAllEmployees"; // Return the JSP page with the filtered list
     }
    
     @RequestMapping("/empcontactus")
     public String empContactUsPage() {
         return "empcontactus"; // This should return the JSP page name.
     }
}